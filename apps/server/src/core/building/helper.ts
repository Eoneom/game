...
export const isProductionBuildingCode = (code: string): code is BuildingCode.RECYCLING_PLANT | BuildingCode.MUSHROOM_FARM | BuildingCode.CENTRAL_INDUCTOR =>
...
export const isConsumingBuildingCode = (code: string): code is BuildingCode.RECYCLING_PLANT | BuildingCode.MUSHROOM_FARM | BuildingCode.CENTRAL_INDUCTOR | BuildingCode.RESEARCH_LAB | BuildingCode.CLONING_FACTORY =>
  code === BuildingCode.RECYCLING_PLANT ||
  code === BuildingCode.MUSHROOM_FARM ||
  code === BuildingCode.CENTRAL_INDUCTOR ||
